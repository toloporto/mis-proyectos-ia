...
def chat():
    """
    Función principal que inicia el chat con DeepSeek (Local).
    Permite al usuario interactuar con el modelo de lenguaje y termina cuando el usuario escribe 'salir'.
    """
