...
def crear_estructura_proyecto(nombre_proyecto):
    ...
    """
    # 1. Definir la ruta base en ~/proyectos/
    ruta_base = os.path.join(os.path.expanduser('~'), 'proyectos', nombre_proyecto)
    ...
    subprocess.run(["python3", "-m", "venv", os.path.join(ruta_base, '.venv')])
    ...
    print("2. Activa tu entorno:   source .venv/bin/activate")
    print("="*40 + "\n")
